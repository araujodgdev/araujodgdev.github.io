...
export default function MobileNav() {
  return (
    <div className="md:hidden">
      <button
        onClick={() => animate(".nav-menu", { right: 0 })}
      ...
      <div className="nav-menu absolute -right-64 top-0 h-screen w-60 bg-stone-100 text-stone-950">
        <button
          onClick={() => animate(".nav-menu", { right: -256 })}
